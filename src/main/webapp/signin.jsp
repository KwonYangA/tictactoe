...
<body>
    ...
    <div class="popup-contents signin-contents common-popup fixed">
        <div class="popup-inner flex-just-center center">
            <p>회원가입이 완료 되었습니다.<br>
                로그인페이지로 돌아갑니다.</p>
            <input type="button" value="로그인 페이지로" id="signin-sucess-btn" class="btn btn-primary" onclick="location.replace('/login')">
        </div>
    </div>
        ...
        <div class="inner form-wrap">
            <div class="form-box">
                <div class="input-box">
                    ...
                    <div class="error-message" id="idCheckError">
                        <p></p>
                    </div>
                </div>
                <div class="input-box">
            ...
            <div class="form-box">
                ...
                <div class="input-box">
                    ...
                    <div class="error-message" id="emilCheckError">
                        <p></p>
                    </div>
                </div>
            </div>
            <div class="form-box">
                <input type="submit" value="가입하기" id="signinBtn" class="btn btn-light">
            </div>
        </div>
    </section>
    ...
    <script src="/js/page/signin.js" type="module"></script>
</body>
</html>